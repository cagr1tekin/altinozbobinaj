        ...
        return (
          <div className="space-y-4">
            <div>
              ...
              >
                Müşteri
                <span className="ml-1 text-pnl-primary-dark" aria-hidden="true">*</span>
              ...
              <select
                ...
                className="w-full rounded-lg border border-pnl-edge bg-pnl-bg px-3 py-2.5 text-sm text-pnl-text focus:border-pnl-edge focus:outline-none focus:ring-1 focus:ring-pnl-primary"
              >
                {musteriler.map((m) => (
