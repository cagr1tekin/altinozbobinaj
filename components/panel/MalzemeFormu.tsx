...
import { formatSayi } from "@/components/panel/ui";
          ...
          <div className="space-y-4">
            ...
            <Alan
              ...
              secenekler={urunler.map((u) => ({
                deger: u.id,
                etiket: `${u.name} (stok: ${u.qty_pieces} adet / ${formatSayi(u.qty_kg)} kg)`,
              }))}
            />
            ...
            <p className="rounded-lg border border-pnl-line bg-pnl-bg px-3 py-2 text-xs text-pnl-muted">
              Malzeme eklemek stoğu <strong className="text-pnl-text">düşürmez</strong>.
              Stok, iş <strong className="text-pnl-text">tamamlandığında</strong> düşülür.
            </p>
