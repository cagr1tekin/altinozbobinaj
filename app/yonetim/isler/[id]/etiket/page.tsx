  ...
  return (
    <>
      ...
      <div className="yazdirma-gizle mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        <Link
          href={`/yonetim/isler/${id}`}
          className="inline-flex min-h-[44px] items-center rounded-xl border border-white/15 px-5 text-sm font-semibold text-paper hover:bg-white/5"
        >
          İş detayına dön
        </Link>
      </div>
      ...
      <p className="yazdirma-gizle mt-4 text-sm text-paper-muted">
        Yazdırmak için <kbd className="rounded border border-white/20 px-1.5 py-0.5 text-xs">Ctrl</kbd>{" "}
        + <kbd className="rounded border border-white/20 px-1.5 py-0.5 text-xs">P</kbd>{" "}
